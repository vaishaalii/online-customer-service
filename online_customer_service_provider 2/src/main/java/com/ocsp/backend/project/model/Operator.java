...
public class Operator  {
	...
	public Operator(int userId, String firstName, String lastName, String password, String dob, String gender,
	...
	public String toString() {
		return "Operator [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName + ", password="
